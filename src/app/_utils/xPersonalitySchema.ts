export const xPersonalitySchema = {
    "type": "object",
    "properties": {
        "orientation": {
            "type": "string",
        ...
        "relationshipStyle": {
            ...
            "enum": ["monogamous", "polyamorous", "open relationship", "swinging"]
        },
        ...
        "speakStyleDuringSex": {
            "type": "string",
            "enum": ["dirty talk", "sweet talk", "sensual whispering", "dominant talk", "submissive talk", "teasing talk", "erotic storytelling", "breathless gasps", "sultry seduction", "playful banter"],
            "example": [
